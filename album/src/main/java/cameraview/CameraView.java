...
import cameraview.controls.Audio;
import cameraview.controls.Control;
import cameraview.controls.ControlParser;
import cameraview.controls.Engine;
import cameraview.controls.Facing;
import cameraview.controls.Flash;
import cameraview.controls.Grid;
import cameraview.controls.Hdr;
import cameraview.controls.Mode;
import cameraview.controls.Preview;
import cameraview.controls.VideoCodec;
import cameraview.controls.WhiteBalance;
import cameraview.engine.Camera1Engine;
import cameraview.engine.Camera2Engine;
import cameraview.engine.CameraEngine;
import cameraview.engine.offset.Reference;
import cameraview.filter.Filter;
import cameraview.filter.FilterParser;
import cameraview.filter.Filters;
import cameraview.filter.NoFilter;
import cameraview.filter.OneParameterFilter;
import cameraview.filter.TwoParameterFilter;
...
import cameraview.gesture.GestureFinder;
import cameraview.gesture.GestureParser;
import cameraview.gesture.PinchGestureFinder;
import cameraview.gesture.ScrollGestureFinder;
import cameraview.gesture.TapGestureFinder;
import cameraview.internal.GridLinesLayout;
import cameraview.internal.utils.CropHelper;
import cameraview.internal.utils.OrientationHelper;
import cameraview.internal.utils.WorkerHandler;
import cameraview.markers.AutoFocusMarker;
import cameraview.markers.AutoFocusTrigger;
import cameraview.markers.MarkerLayout;
import cameraview.markers.MarkerParser;
import cameraview.overlay.OverlayLayout;
import cameraview.preview.CameraPreview;
import cameraview.preview.FilterCameraPreview;
import cameraview.preview.GlCameraPreview;
import cameraview.preview.SurfaceCameraPreview;
import cameraview.preview.TextureCameraPreview;
import cameraview.size.AspectRatio;
import cameraview.size.Size;
import cameraview.size.SizeSelector;
import cameraview.size.SizeSelectorParser;
import cameraview.size.SizeSelectors;
...
public class CameraView extends FrameLayout implements LifecycleObserver {
     ...
     */
    public void setLifecycleOwner(@NonNull Lifecycle owner) {
