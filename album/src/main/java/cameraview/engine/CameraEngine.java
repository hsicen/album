...
import cameraview.engine.offset.Angles;
...
import cameraview.video.VideoRecorder;
...
public abstract class CameraEngine implements
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.PROTECTED)
    Op<Void> mPreviewFrameRateOp = new Op<>();
